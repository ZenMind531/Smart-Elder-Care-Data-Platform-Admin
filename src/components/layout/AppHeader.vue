    ...
    <div class="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
      ...
      >
        ...
        <div class="hidden min-w-0 lg:block">
          <h1 class="truncate text-theme-sm font-semibold text-gray-900 dark:text-white">
            {{ pageTitle }}
          </h1>
      ...
      >
        <div class="flex items-center gap-2 2xsm:gap-3">
          <span
            class="hidden rounded-lg border border-gray-200 px-3 py-2 text-theme-xs text-gray-500 dark:border-gray-800 dark:text-gray-400 xl:inline-flex"
          >
            {{ formattedDate }}
          </span>
          <ThemeToggler />
...
const pageTitle = computed(() => String(route.meta.title || '智慧养老管理系统'))
