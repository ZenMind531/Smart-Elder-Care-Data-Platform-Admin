  ...
  <div class="relative" ref="dropdownRef">
    ...
    >
      <span
        ...
        class="absolute right-0 top-0.5 z-1 size-2 rounded-full bg-brand-500"
      >
        <span class="absolute inline-flex size-full rounded-full bg-brand-500 opacity-75 -z-1 animate-ping"></span>
      </span>
    ...
    <div
      v-if="dropdownOpen"
      class="absolute -right-[240px] mt-[17px] flex h-[430px] w-[350px] flex-col rounded-[18px] border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark sm:w-[361px] lg:right-0"
    >
